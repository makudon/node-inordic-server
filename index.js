...
require('./routes/get-all-good')(app, connect)
require('./routes/get-item')(app, connect)
require('./routes/del-item')(app, connect)
require('./routes/add-item')(app, connect)
require('./routes/add-item')(app, connect)
require('./routes/edit-item')(app, connect)
